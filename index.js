...
// Cold start fix — একবারই connect করবে
...
app.post("/users", async (req, res) => {
  ...
  if (isExist) {
    res.send({
      message: "User email already exist. Please try another email or account",
    });
    return;
  } else {
...
//read bids by product অবশ্যই /products/:id এর আগে থাকবে
